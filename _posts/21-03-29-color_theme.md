...
PPvの配色はPPcustから変更するか、CV_charを直接変更することで設定できます。
しかし色の設定は時間がかかってあちへんな割にできあがりも微妙だったりするので、
...
- M_theme
  ...
  - createColorTheme\.jsの初期設定で定数"THEME_DIR_PATH"を変更した場合は
